...
type ExtractReturnType = <Return>(a: (...rest: any[]) => Return) => Return;

declare module "reselect" {
  type InputSelector<TState, TProps, TResult> = (
    state: TState,
    props: TProps,
    ...rest: any[]
  ) => TResult;

  type OutputSelector<TState, TProps, TResult> = InputSelector<
    TState,
    TProps,
    TResult
  > & {
  ...
  type Reselect = {
    ...
    defaultMemoize: <TFunc extends Function>(
      func: TFunc,
    ...
    createStructuredSelector: <
      TState,
      TProps,
      InputSelectors extends {
        [k in string | number]: InputSelector<TState, TProps, any>;
      }
    >(
